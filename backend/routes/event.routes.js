...
import { createEvent, deleteEvent, joinUnjoinEvent, getAllEvents, getJoinedEvents, getUserEvents, updateEvent, getEventById } from '../controllers/event.controller.js';

const router = express.Router();

router.get("/all", getAllEvents);
router.get("/:id", getEventById);
router.get("/joined/:id", protectRoute, getJoinedEvents);
