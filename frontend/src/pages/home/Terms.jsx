...
const Terms = () => {
  return (
    <div className="container mx-auto px-6 py-12 text-black">
      ...
      <p className="mb-6">
        - Eligibility: You must be at least [minimum age] to use our platform.<br />
        - Account Registration: To access certain features, you may need to create an account. You agree to provide accurate and complete information and keep your account details confidential.<br />
        - Acceptable Use: You agree not to use our platform for illegal activities, spamming, or any activity that could harm the platform or other users.
      </p>

      <h2 className="text-xl font-semibold mb-4">3. User Content</h2>
      <p className="mb-6">
        - Ownership: You retain ownership of the content you upload or share on our platform.<br />
        - License: By submitting content, you grant us a non-exclusive, royalty-free license to use, display, and distribute the content in connection with our services.
      </p>

      <h2 className="text-xl font-semibold mb-4">4. Payment and Fees</h2>
      <p className="mb-6">
        - Fees: Some features or services on our platform may require payment. You agree to pay all applicable fees in accordance with our pricing structure.<br />
        - Refund Policy: [Specify your refund policy, if any.]
      </p>
      ...
      <p className="mb-6">
        All content, trademarks, logos, and intellectual property on the platform are owned by [Your App/Website Name] or its licensors. You may not use our intellectual property without prior written consent.
      </p>

      <h2 className="text-xl font-semibold mb-4">8. Governing Law</h2>
      <p className="mb-6">
        These Terms and Conditions are governed by and construed in accordance with the laws of [Your Country/State]. Any disputes will be resolved in the courts located in [Your Jurisdiction].
      </p>
